...
/////// url type -----  http://localhost/php_api_ok/api_get_all_data.php?category=district&id=6
...
///// as per all category id

///// url is like -----   http://localhost/php_api_ok/api_get_all_data.php?id=8
